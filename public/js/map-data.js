...
(function () {
  ...
  function getName(cc) {
    var lang = window.txidMap.lang || 'en';
  ...
  var CENTROIDS = {
    ...
    // Extended: Pacific, Americas, Europe, Africa, Asia
    IE:[-8,53],IS:[-19,65],NZ:[174,-41],SI:[15,46],CL:[-71,-35],LU:[6.1,49.8],
    CO:[-74,4],LI:[9.5,47.2],CR:[-84,10],KE:[38,-1],VE:[-66,7],PR:[-66,18],
    MD:[29,47],UY:[-56,-33],IR:[53,32],BY:[28,53],NG:[8,10],PA:[-80,9],
    PY:[-58,-23],KW:[48,29],MT:[14.4,35.9],BA:[18,44],PE:[-76,-10],CW:[-69,12],
    CY:[33,35],AM:[45,40],BH:[50.5,26],AL:[20,41],KG:[75,41],GH:[-1.5,8],
    AD:[1.5,42.5],BS:[-77,25],BM:[-64.8,32.3],AI:[-63,18.2],SV:[-89,14],RS:[21,44],
    SY:[38,35],LB:[35.8,34],QA:[51.2,25.3],AZ:[50,40.5],GE:[43.5,42],
    RE:[55.5,-21],YT:[45.2,-12.8],LK:[81,7.5],MV:[73,3.2],NP:[84,28],
    MO:[113.5,22.2],KH:[105,12.5],FO:[-7,62],JE:[-2.1,49.2],IM:[-4.5,54.2],
    VA:[12.5,41.9],ME:[19.3,42.7],AO:[18.5,-12.5],DO:[-70,19],CU:[-80,22],
    VG:[-64.6,18.4],BZ:[-88.5,17.2],BO:[-65,-17],SC:[55.5,-4.7],
  };
